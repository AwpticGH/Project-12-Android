package g10.manga.comicable.frontend.listener.callback.activity.series;
...
import g10.manga.comicable.frontend.listener.activity.comic.series.ButtonCollectionListener;
...
public class SeriesCallback<T> extends BaseListener implements Callback<T> {
    ...
    private ButtonCollectionListener ibCollectionListener;
        ...
        try {
            ...
            if (responseModel != null) {
                if (ResponseFlag.isSuccessful(responseModel) || ResponseFlag.isPartiallySuccessful(responseModel)) {
                    ...
                    RelativeLayout relativeLayout = activity.findViewById(R.id.rl_activity_series);
    ...
    private void initDetail(SeriesModel model) {
        ...
        ibCollection = activity.findViewById(R.id.ib_collection_activity_series);
        ibCollectionListener = new ButtonCollectionListener(activity, model, ibCollection);
        ibCollection.setOnClickListener(ibCollectionListener);
    }
